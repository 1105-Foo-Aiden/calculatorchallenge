...
import DisplayComponent from "@/Componants/Display/Page";
...
export default function Home() {
  ...
  const [IsTipSelected, setIsTipSelected] = useState<boolean>(false);
  ...
  useEffect(() =>{
    console.table({billAmt, peeps, customTip})
  }, [billAmt, peeps, customTip])
