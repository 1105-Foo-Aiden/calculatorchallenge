...
export default function Home() {
  ...
  }, [numOfPeople, tipAmount, total, tip])
        ...
        <div className="flex items-center min-w-[1000px] bg-white border border-gray-200 rounded-3xl shadow md:flex-row md:max-w-xl">
          <div className="grid grid-flow-rows p-5">
            ...
            <div className="grid grid-cols-3 gap-3 ">
              <button type="button" className="hover:text-[#00494d] hover:bg-[#26c0ab]  active:text-[#00494d] active:bg-[#26c0ab] focus:outline-none text-[24px] text-white bg-[#00494d] font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:focus:ring-green-800" onClick={() => handleRadioChange('5')}>5%
              </button>
              <button type="button"
               className="hover:text-[rgb(0,73,77)] hover:bg-[#26c0ab]  active:text-[#00494d] active:bg-[#26c0ab] focus:outline-none text-[24px] text-white bg-[#00494d] font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:focus:ring-green-800" onClick={() => handleRadioChange('10')}>10%
              </button>
              <button type="button" className="hover:text-[#00494d] hover:bg-[#26c0ab]  active:text-[#00494d] active:bg-[#26c0ab] focus:text-[#00494d] focus:bg-[#26c0ab] focus:outline-none text-[24px] text-white bg-[#00494d] font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:focus:ring-green-800" onClick={() => setTip(15)} >15%</button>

              <button type="button" className="hover:text-[#00494d] hover:bg-[#26c0ab]  active:text-[#00494d] active:bg-[#26c0ab] focus:outline-none text-[24px] text-white bg-[#00494d] font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:focus:ring-green-800" onClick={() => handleRadioChange('25')} >25%</button>
              <button type="button" className="hover:text-[#00494d] hover:bg-[#26c0ab]  active:text-[#00494d] active:bg-[#26c0ab] focus:outline-none text-[24px] text-white bg-[#00494d] font-medium rounded-lg  px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:focus:ring-green-800" onClick={() => handleRadioChange('50')}>50%</button>
